...
@section('content')
  ...
  <div class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
    <div>
        ...
        <h1 class="md:mb-16 mb-12 font-extrabold md:text-[36px] sm:text-[24px] text-[16px] text-[#BD0707]">Product</h1>
            <div class="flex md:gap-9 sm:gap-6 gap-4 mb-4 md:mb-8 flex-wrap">
                ...
                <form class="mb-5" 
                    ...
                    @method('DELETE')
                    @csrf
                    <div class="md:w-[60%] rounded-[8px] w-[45%] relative bg-[#F6DADA]">
                      ...
                      <div class="inline-flex rounded-[8px] w-[45%] relative bg-[#F6DADA]">
                        <button type="submit"class="bg-blue-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l">Delete</button>
                        <a href="{{url('updateproduct/'.$product->id)}}" class="bg-grey-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-r">Update</a>
                      </div>
                    </form>
                @endforeach
            </div>
        ...
        <a href="{{url('addproduct')}}" style="transition:.3s; -webkit-tap-highlight-color: rgba(0,0,0,0);position: fixed; bottom: 16px;right: 16px;" class="overflow-scroll"><svg class="h-16 w-16 text-red-500"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="12" r="9" />  <line x1="9" y1="12" x2="15" y2="12" />  <line x1="12" y1="9" x2="12" y2="15" /></svg></a>
</div>
@endsection