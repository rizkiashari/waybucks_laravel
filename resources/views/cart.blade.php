            ...
            <div class="md:w-2/5 w-full px-10 pt-12">
                <form action="/transaction" method="POST" enctype="multipart/form-data ">
                    <div class="form-group mb-6">
                        <input type="text" class="form-control block w-full px-3 py-2 text-[#68323280] font-normal text-lg bg-[#E0C8C840] bg-clip-padding border-2 border-solid border-[#BD0707] rounded-md transition ease-in-out m-0" placeholder="Name" />
                    </div>

                    <div class="form-group mb-6">
                        <input type="email" class="form-control block w-full px-3 py-2 text-[#68323280] font-normal text-lg bg-[#E0C8C840] bg-clip-padding border-2 border-solid border-[#BD0707] rounded-md transition ease-in-out m-0" placeholder="Email address" />
                    </div>

                    <div class="form-group mb-6">
                        <input type="text" class="form-control block w-full px-3 py-2 text-[#68323280] font-normal text-lg bg-[#E0C8C840] bg-clip-padding border-2 border-solid border-[#BD0707] rounded-md transition ease-in-out m-0" placeholder="Phone" />
                    </div>

                    <div class="form-group mb-6">
                        <input type="text" class="form-control block w-full px-3 py-2 text-[#68323280] font-normal text-lg bg-[#E0C8C840] bg-clip-padding border-2 border-solid border-[#BD0707] rounded-md transition ease-in-out m-0" placeholder="Post Code" />
                    </div>
                    
                    <div class="form-group mb-6">
                        <textarea class="form-control block w-full px-3 py-2 text-[#68323280] font-normal text-lg bg-[#E0C8C840] bg-clip-padding border-2 border-solid border-[#BD0707] rounded-md transition ease-in-out m-0" rows="3" placeholder="Address"
                        ></textarea>
                    </div>
