            ...
            <div class="border-b-2 border-[#974A4A] pb-5">
                <div class="flex h-28 my-6 justify-between">
                    <div class="flex gap-6">
                        <div>
                            <img class="h-28 w-28 object-cover rounded-md" src="https://images.unsplash.com/photo-1562447457-579fc34967fb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="">
                        </div>
            ...
            <form>
                <div class="form-group mb-6">
                  <input type="text" class="form-control block
                    ...
                    px-3
                    py-2
                    text-[#68323280] font-normal text-lg
                    bg-[#E0C8C840] bg-clip-padding
                    border-2 border-solid border-[#BD0707]
                    rounded-md
                    transition
                    ease-in-out
                    m-0" id="exampleInput7"
                    placeholder="Name">
                </div>
                ...
                <button type="submit" class="
                  ...
                  rounded-md
                  shadow-md
                  hover:bg-[#a31b1b] hover:shadow-lg
                  transition
                  duration-150
                  ease-in-out">Pay</button>
              </form>
        </div>
    </div>
</div>
